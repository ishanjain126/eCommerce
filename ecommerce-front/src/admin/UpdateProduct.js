...
const UpdateProduct = ({match}) => {
    ...
    // when the component mounts, init method runs, fetch the single product and the categories as well
    ...
    // load categories and save form data
    ...
    // will execute init method to load the products
