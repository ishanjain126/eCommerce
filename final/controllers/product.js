...
// decrease the quantity of the products purchased in the database

exports.decreaseQuantity = (req, res, next) => {

    // map through each product getting into order body
    // decrement the count and increase the sold
